...
class PersonalPage(BasePage):
    ...
    def change_name(self, new_name):
        with allure.step(f"Change name on '{new_name}'"):
            ...
            assert first_name_field.get_attribute("value") == '', "theres a text"
    ...
    def is_changes_saved(self):
        ...
        self.driver.refresh()
        self.wait.until(EC.invisibility_of_element_located(self.SPINNER))
        DROPDOWN_NAME = ("xpath", f"//p[contains(text(), '{self.name}') and @class='oxd-userdropdown-name']")
        self.wait.until(EC.visibility_of_element_located(DROPDOWN_NAME))
